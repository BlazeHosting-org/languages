<?php
// CENSORED WHMCS CODE
$_LANG['accountinfo'] = "Bruker Informasjon";
$_LANG['accountstats'] = "Bruker Statistikk";
$_LANG['addfunds'] = "Legg Til Penger";
$_LANG['addfundsamount'] = "Beløp å legge til";
$_LANG['addfundsmaximum'] = "Maksimalt Innskudd";
$_LANG['addfundsmaximumbalance'] = "Maksimal Saldo";
$_LANG['addfundsmaximumbalanceerror'] = "Maksimal Saldobeløp er";
$_LANG['addfundsmaximumerror'] = "Maksimal Innskudd beløp er";
$_LANG['addfundsminimum'] = "Minimumsinnskudd";
$_LANG['addfundsminimumerror'] = "Minimum innskuddsbeløp er";
$_LANG['addmore'] = "Legg til mer";
$_LANG['addtocart'] = "Legg til i handlekurven";
$_LANG['affiliatesactivate'] = "Aktiver tilknyttet konto";
$_LANG['affiliatesamount'] = "Beløp";
$_LANG['affiliatesbalance'] = "Nåværende saldo";
$_LANG['affiliatesbullet1'] = "Motta et første bonusinnskudd på din tilknyttede konto av";
$_LANG['affiliatesbullet2'] = "av hver betaling hver kunde du henviser til oss gjør for hele varigheten av vertskontoen deres";
$_LANG['affiliatescommission'] = "Provisjon";
$_LANG['affiliatesdescription'] = "Bli med i vårt tilknyttet program eller se inntekter";
$_LANG['affiliatesdisabled'] = "Vi tilbyr for øyeblikket ikke et tilknyttet system til våre kunder.";
$_LANG['affiliatesearn'] = "Tjen";
$_LANG['affiliatesearningstodate'] = "Total inntjening til dags";
$_LANG['affiliatesfootertext'] = "Når du henviser noen til nettstedet vårt med din unike henvisnings-ID, plasseres en informasjonskapsel på datamaskinen deres som inneholder denne ID-en, så hvis de bokmerker nettstedet og kommer tilbake senere vil du fortsatt motta provisjonen.";
$_LANG['affiliateshostingpackage'] = "Vert pakke";
$_LANG['affiliatesintrotext'] = "Aktiver din tilknyttedekonto i dag for å:";
$_LANG['affiliateslinktous'] = "Link til Oss";
$_LANG['affiliatesnosignups'] = "Du har for øyeblikket ikke mottatt noen registreringer";
$_LANG['affiliatesrealtime'] = "Denne statistikken er i sanntid og oppdateres umiddelbart";
$_LANG['affiliatesreferallink'] = "Din unike henvisningskobling";
$_LANG['affiliatesreferals'] = "Dine henvisninger";
$_LANG['affiliatesregdate'] = "Registreringsdato";
$_LANG['affiliatesrequestwithdrawal'] = "Be om uttak";
$_LANG['affiliatessignupdate'] = "Registreringsdato";
$_LANG['affiliatesstatus'] = "Status";
$_LANG['affiliatestitle'] = "Tilknyttede";
$_LANG['affiliatesvisitorsreferred'] = "Antall besøkende henvist";
$_LANG['affiliateswithdrawalrequestsuccessful'] = "Din forespørsel om uttak er sendt. Du vil bli kontaktet innen kort tid.";
$_LANG['affiliatesWithdrawalRequestUnsuccessful'] = "Din forespørsel om uttak var ikke vellykket. Prøv igjen senere.";
$_LANG['affiliateswithdrawn'] = "Totalt trukket beløp";
$_LANG['all'] = "Alle";
$_LANG['alreadyregistered'] = "Allerede Registrert?";
$_LANG['announcementsdescription'] = "Se våre siste nyheter og kunngjøringer";
$_LANG['announcementsnone'] = "Ingen kunngjøringer å vise";
$_LANG['announcementsrss'] = "Se RSS-feed";
$_LANG['announcementstitle'] = "Kunngjøringer";
$_LANG['announcementscontinue'] = "Fortsett å lese";
$_LANG['bannedbanexpires'] = "Utestengelsen utløper";
$_LANG['bannedbanreason'] = "Grunnen for utestengelsen";
$_LANG['bannedhasbeenbanned'] = "har blitt utestengt";
$_LANG['bannedtitle'] = "IP utestengt";
$_LANG['bannedyourip'] = "Din IP";
$_LANG['cartaddons'] = "Tillegg";
$_LANG['cartbrowse'] = "Bla gjennom produkter &amp; Tjenester";
$_LANG['cartconfigdomainextras'] = "Konfigurer domenetillegg";
$_LANG['cartconfigoptionsdesc'] = "Dette produktet/tjenesten har noen alternativer som du kan velge fra nedenfor for å tilpasse bestillingen din.";
$_LANG['cartconfigserver'] = "Konfigurer server";
$_LANG['cartcustomfieldsdesc'] = "Dette produktet/tjenesten krever litt tilleggsinformasjon fra deg for å tillate oss å behandle bestillingen din.";
$_LANG['cartdomainsconfig'] = "Domenekonfigurasjon";
$_LANG['cartdomainsconfigdesc'] = "Nedenfor kan du konfigurere domenenavnene i handlekurven ved å velge tilleggstjenestene du ønsker, gi nødvendig informasjon for dem og definere navneserverne de vil bruke.";
$_LANG['cartdomainshashosting'] = "Har Vertskap";
$_LANG['cartdomainsnohosting'] = "Ingen Vertskap! Klikk for å legge til";
$_LANG['carteditproductconfig'] = "Rediger konfigurasjon";
$_LANG['cartempty'] = "Handlekurven din er tom";
$_LANG['cartemptyconfirm'] = "Er du sikker på at du vil tømme handlekurven?";
$_LANG['cartexistingclientlogin'] = "Eksisterende klientpålogging";
$_LANG['cartexistingclientlogindesc'] = "For å legge til denne bestillingen til din eksisterende konto, må du logge inn nedenfor.";
$_LANG['cartnameserversdesc'] = "Hvis du vil bruke egendefinerte navneservere, skriv dem inn nedenfor. Som standard vil nye domener bruke navneserverne våre for vertskap på nettverket vårt.";
$_LANG['cartproductaddons'] = "Produkttillegg";
$_LANG['cartproductaddonschoosepackage'] = "Velg Pakke";
$_LANG['cartproductaddonsnone'] = "Ingen tillegg tilgjengelig for dine produkter &amp; Tjenester";
$_LANG['cartproductconfig'] = "Produktkonfigurasjon";
$_LANG['cartproductdesc'] = "Produktet/tjenesten du har valgt har følgende konfigurasjonsalternativer du kan velge mellom.";
$_LANG['cartproductdomain'] = "Domener";
$_LANG['cartproductdomainchoose'] = "Velg et domene";
...
$_LANG['cartproductdomainuseincart'] = "Bruk et domene som allerede er i handlekurven min";
$_LANG['cartremove'] = "Fjern";
$_LANG['cartremoveitemconfirm'] = "Er du sikker på at du vil fjerne denne varen fra handlekurven din?";
$_LANG['carttaxupdateselections'] = "Avgifter kan bli belastet avhengig av staten og landet du velger. Klikk for å beregne på nytt etter at du har valgt.";
$_LANG['carttaxupdateselectionsupdate'] = "Oppdater";
$_LANG['carttitle'] = "Handlekurv";
$_LANG['changessavedsuccessfully'] = "Endringer lagret vellykket!";
$_LANG['checkavailability'] = "Sjekk tilgjengelighet";
$_LANG['checkout'] = "Sjekk ut";
$_LANG['choosecurrency'] = "Velg Valuta";
$_LANG['choosedomains'] = "Velg domener";
$_LANG['clickheretologin'] = "Klikk her for å logge inn";
$_LANG['clientareaaccountaddons'] = "Kontotillegg";
$_LANG['clientareaactive'] = "Aktiv";
$_LANG['clientareaaddfundsdisabled'] = "Vi tillater ikke å sette inn penger på forhånd hos oss på det nåværende tidspunkt.";
$_LANG['clientareaaddfundsnotallowed'] = "Du må ha minst én aktiv ordre før du kan legge til penger, slik at du ikke kan fortsette på det nåværende tidspunktet!";
$_LANG['clientareaaddon'] = "Tillegg";
$_LANG['clientareaaddonorderconfirmation'] = "Takk skal du ha. Din bestilling for tillegget vist nedenfor er lagt inn. Velg betalingsmåte nedenfor.";
$_LANG['clientareaaddonpricing'] = "Prissetting";
$_LANG['clientareaaddonsfor'] = "Tillegg for";
$_LANG['clientareaaddress1'] = "Adresse 1";
$_LANG['clientareaaddress2'] = "Adresse 2";
$_LANG['clientareabwlimit'] = "Båndbreddegrense";
$_LANG['clientareabwusage'] = "Båndbreddebruk";
$_LANG['clientareacancel'] = "Avbryt endringer";
...
$_LANG['creditcardccvinvalid'] = "Kortets CVV nummer er nødvendig";
$_LANG['creditcardconfirmation'] = "Takk! Dine nye kort detaljer har blitt akseptert og den første betalingen til kontoen din har blitt gjennomført. Du har fått en email med bekreftelse på betalingen.";
...
$_LANG['creditcarddeclined'] = "Kredittkortopplysningene du oppga ble avslått. Vennligst prøv et annet kort eller kontakt brukerstøtte.";
$_LANG['creditcarddetails'] = "Kredittkortopplysninger";
$_LANG['creditcardenterexpirydate'] = "Du har ikke oppgitt kortets utløpsdato";
$_LANG['creditcardenternewcard'] = "Oppgi nye kortdetaljer nedenfor";
$_LANG['creditcardenternumber'] = "Du har ikke oppgitt kortnummeret ditt";
$_LANG['creditcardinvalid'] = "Kredittkortopplysningene du oppga var ugyldige. Vennligst prøv et annet kort eller kontakt brukerstøtte.";
$_LANG['creditcardnumberinvalid'] = "Kredittkortnummeret du oppga er ugyldig";
$_LANG['creditcardsecuritynotice'] = "Alle opplysninger du oppgir her sendes inn sikkert og er kryptert for å redusere risikoen for svindel";
$_LANG['creditcarduseexisting'] = "Bruk eksisterende kort";
$_LANG['customfieldvalidationerror'] = "Verdien er ugyldig";
$_LANG['days'] = "Dager";
$_LANG['hours'] = "Timer";
...
$_LANG['domainavailableexplanation'] = "For å registrere dette domenet, klikk på lenken under";
$_LANG['domainbulksearch'] = "Bulk Domain Search";
$_LANG['domainbulksearchintro'] = "Sann-tids domenenavn massesøk lar deg søke etter 20 forskjellige domener samtidig.  Skriv inn domenene i feltet nedenfor, en per linje - ikke inkluder www. eller http:// forran.";
$_LANG['domainbulktransferdescription'] = "Du kan overføre dine eksisterende domener til oss i dag.  For å sette i gang, fyll simpelt domenene inn nedenfor, en per linje - ikke inkluder www. eller http://";
$_LANG['domainbulktransfersearch'] = "Domene Masseoverføring";
$_LANG['domaincontactinfo'] = "Kontaktinformasjon";
$_LANG['domaincurrentrenewaldate'] = "Nåværende fornyings dato";
$_LANG['domaindnsaddress'] = "Adresse";
$_LANG['domaindnshostname'] = "Vertsnavn";
$_LANG['domaindnsmanagement'] = "DNS Oversikt";
$_LANG['domaindnsmanagementdesc'] = "Rett domenet ditt mot en nettside ved å rette mot en IP adresse, eller videresend til en annen side, eller rett mot en midlertidig side (kjent som Parking), og mer. Disse postene er også kjent som sub-domener.";
$_LANG['domaindnsrecordtype'] = "Posttype";
$_LANG['domainemailforwarding'] = "Email Videresending";
$_LANG['domainemailforwardingdesc'] = "Hvis Email Videresending Serveren finner \"Forward To\" adressen ugyldig, vil vi deaktivere videresendingsposten automatisk. Venligst sjekk \"Forward To\" adressen før du aktiverer den igjen. Ved endringer på eksisterende videresendings poster kan det ta opptil 1 time før de tas i bruk.";
$_LANG['domainemailforwardingforwardto'] = "Videresend Til";
$_LANG['domainemailforwardingprefix'] = "Prefiks";
$_LANG['domaineppcode'] = "EPP Kode";
$_LANG['domaineppcodedesc'] = "Dette må innhentes fra gjeldene register for autorisasjon";
$_LANG['domaineppcoderequired'] = "Du må fylle inn EPP koden for";
$_LANG['domainerror'] = "Det oppsto problemer under tilkoblingen til domene registeret. Vennligst prøv igjen senere.";
$_LANG['domainerrornodomain'] = "Vennligst oppgi et gyldig domene navn";
$_LANG['domainerrortoolong'] = "Domenet du har oppgitt er for langt. Domener kan ha en maksimal lengde på 67 tegn.";
$_LANG['domaingeteppcode'] = "Hent EPP kode";
$_LANG['domaingeteppcodeemailconfirmation'] = "EPP Kode-forespørselen var suksessfull! Den har blitt sendt til den registrerte email adressen til domenet ditt.";
$_LANG['domaingeteppcodeexplanation'] = "EPP Koden er et slags passord for et domenenavn. Det er et sikkerhetstiltak som sikrer at kun eieren av domenet kan overføre det. Du vil trenge denne koden dersom du vil overføre domenet til en annen registrert bruker.";
$_LANG['domaingeteppcodefailure'] = "Det oppsto en feil under innhenting av EPP koden:";
$_LANG['domaingeteppcodeis'] = "EPP Koden for ditt domene er:";
$_LANG['domainidprotection'] = "ID Beskyttelse";
$_LANG['domainintrotext'] = "Fyll inn domenet og TLD'en du ønsker å bruke i boksene under, og klikk \"Lookup\" for å sjekke om domenet er tilgjengelig for kjøp.";
$_LANG['domainlookupbutton'] = "Sjekk";
$_LANG['domainmanagementtools'] = "Administrasjonsverktøy";
$_LANG['domainminyears'] = "Min. År";
$_LANG['domainmoreinfo'] = "Mer info";
$_LANG['domainname'] = "Domenenavn";
$_LANG['domainnameserver1'] = "Navngiserver 1";
$_LANG['domainnameserver2'] = "Navngiserver 2";
$_LANG['domainnameserver3'] = "Navngiserver 3";
$_LANG['domainnameserver4'] = "Navngiserver 4";
$_LANG['domainnameserver5'] = "Navngiserver 5";
$_LANG['domainnameservers'] = "Navngiservere";
$_LANG['domainordernow'] = "Bestill nå!";
$_LANG['domainorderrenew'] = "Bestillingsfornyelse";
$_LANG['domainprice'] = "Pris";
$_LANG['domainregisterns'] = "Register Navngiservere";
$_LANG['domainregisternscurrentip'] = "Nåværende IP Adresse";
$_LANG['domainregisternsdel'] = "Slett en NameServer";
$_LANG['domainregisternsdelsuccess'] = "Nameserver'en ble slettet";
$_LANG['domainregisternsexplanation'] = "Her kan du lage og endre på navnservere til ditt domene (f.eks. NS1.example.com, NS2.example.com...).";
$_LANG['domainregisternsip'] = "IP Adresse";
$_LANG['domainregisternsmod'] = "Modifiser en NameServer IP";
$_LANG['domainregisternsmodsuccess'] = "Nameserver'en  ble endret på";
$_LANG['domainregisternsnewip'] = "Ny IP Adresse";
$_LANG['domainregisternsns'] = "Nameserver";
$_LANG['domainregisternsreg'] = "Registrer et NameServer navn";
$_LANG['domainregisternsregsuccess'] = "Nameserver'en ble registrert";
$_LANG['domainregistrantchoose'] = "Velg kontakten du vil bruke her";
$_LANG['domainregistrantinfo'] = "Domene Registrant Informasjon";
$_LANG['domainregistrarlock'] = "Registrant Lås";
$_LANG['domainregistrarlockdesc'] = "Skru på registrant lås (Anbefalt). Uautoriserte overføringer vil bli hindret hvis låsen er skrudd på.";
$_LANG['domainregistration'] = "Domene Registrering";
$_LANG['domainregistryinfo'] = "Domene Registrerings Informasjon";
$_LANG['domainregnotavailable'] = "N/A";
$_LANG['domainrenew'] = "Forny Domene";
$_LANG['domainrenewal'] = "Domene Fornyelse";
$_LANG['domainrenewalprice'] = "Fornyelse";
$_LANG['domainrenewdesc'] = "Sikre dine domene(r) ved å holde på de lenger. Velg hvor mange år du vil fornye for og send inn for å fortsette.";
$_LANG['domainsautorenew'] = "Automatisk Fornyelse";
$_LANG['domainsautorenewdisable'] = "Skru av automatisk fornyelse";
$_LANG['domainsautorenewdisabled'] = "Deaktivert";
$_LANG['domainsautorenewdisabledwarning'] = "ADVARSEL! Dette domenet har automatisk fornyelse skrudd av.<br />Det vil derfor utløpe og bli inaktivt ved slutten av den nåværende perioden med mindre den manuelt blir fornyet.";
$_LANG['domainsautorenewenable'] = "Aktiver automatisk fornyelse";
$_LANG['domainsautorenewenabled'] = "Aktivert";
$_LANG['domainsautorenewstatus'] = "Nåværende Status";
$_LANG['domainsimplesearch'] = "Enkelt Domene Søk";
$_LANG['domainspricing'] = "Domene Priser";
...
$_LANG['domaintitle'] = "Domene Sjekker";
$_LANG['domaintld'] = "TLD";
$_LANG['domaintransfer'] = "Domene Overføring";
$_LANG['domainunavailable'] = "Utilgjengelig";
$_LANG['domainunavailable1'] = "Beklager!";
$_LANG['domainunavailable2'] = "er allerede tatt!";
$_LANG['domainreserved'] = "Reservert";
$_LANG['domainreserved1'] = "Domene";
$_LANG['domainreserved2'] = "er tilgjengelig, men reservert.";
$_LANG['domainviewwhois'] = "se \"HvemEr\" rapport";
$_LANG['downloaddescription'] = "Beskrivelse";
$_LANG['downloadloginrequired'] = "Tilgang  Nektet - Du må være logget inn for å laste ned denne filen";
$_LANG['downloadname'] = "Nedlast";
$_LANG['downloadpurchaserequired'] = "Tilgang Nektet - Du må betale for produktet før du kan laste dette ned";
$_LANG['downloadscategories'] = "Kategorier";
$_LANG['downloadsdescription'] = "Se vårt bibliotek av nedlastninger";
$_LANG['downloadsfiles'] = "Filer";
$_LANG['downloadsfilesize'] = "Filstørrelse";
$_LANG['downloadsintrotext'] = "Nedlastningsbiblioteket har alle manualer, programmer og andre filer som du kan  trenge for å få din nettside til å fungere.";
$_LANG['downloadspopular'] = "Populære nedlastinger";
$_LANG['downloadsnone'] = "Ingen nedlastinger å vise";
$_LANG['downloadstitle'] = "Nedlastinger";
$_LANG['email'] = "Email";
$_LANG['emptycart'] = "Tøm vogn";
$_LANG['existingpassword'] = "Eksisterende passord";
$_LANG['existingpasswordincorrect'] = "Ditt eksisterende passord var feil";
$_LANG['firstpaymentamount'] = "Første betalingsbeløp";
$_LANG['flashtutorials'] = "Flash-veiledninger";
$_LANG['flashtutorialsdescription'] = "Klikk her for å se veiledninger som viser deg hvordan du skal bruke kontrollpanelet";
...
$_LANG['addfundsnonrefundable'] = "* Ingen innskudd kan refunderes";
