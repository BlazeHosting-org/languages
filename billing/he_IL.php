<?php
// CENSORED WHMCS CODE
$_LANG['accountinfo'] = "פרטי חשבון";
$_LANG['accountstats'] = "סטטיסטיקת חשבון";
$_LANG['addfunds'] = "הוסף כספים";
$_LANG['addfundsamount'] = "כמות להוסיף";
$_LANG['addfundsmaximum'] = "פיקדון מקסימלי";
$_LANG['addfundsmaximumbalance'] = "כסף מירבי";
$_LANG['addfundsmaximumbalanceerror'] = "סכום היתרה המקסימלי הוא";
$_LANG['addfundsmaximumerror'] = "סכום ההפקדה המרבי הוא";
$_LANG['addfundsminimum'] = "הפקדה מינימלית";
$_LANG['addfundsminimumerror'] = "סכום הפקדה מינימלי הוא";
$_LANG['addmore'] = "הוסף עוד";
$_LANG['addtocart'] = "הוסף לעגלה";
$_LANG['affiliatesactivate'] = "הפעל חשבון שותף";
$_LANG['affiliatesamount'] = "כמות";
$_LANG['affiliatesbalance'] = "יתרה נוכחית";
$_LANG['affiliatesbullet1'] = "קבל הפקדת בונוס ראשונית בחשבון השותף שלך של";
$_LANG['affiliatesbullet2'] = "מכל תשלום שכל לקוח שאתה מפנה אלינו משלם במשך כל תקופת חשבון האירוח שלו";
$_LANG['affiliatescommission'] = "עמלה";
$_LANG['affiliatesdescription'] = "הצטרף לתוכנית השותפים שלנו או צפה ברווחים";
$_LANG['affiliatesdisabled'] = "אנו לא מציעים כיום מערכת שותפים ללקוחותינו.";
$_LANG['affiliatesearn'] = "הרווח";
$_LANG['affiliatesearningstodate'] = "סך הרווחים עד היום";
$_LANG['affiliatesfootertext'] = "כאשר אתה מפנה מישהו לאתר האינטרנט שלנו עם מזהה ההפניה הייחודי שלך, קובץ cookie מוצב במחשב שלו המכיל את המזהה הזה כך שאם הוא יסמן את האתר ויחזור מאוחר יותר, עדיין תקבל את העמלה.";
$_LANG['affiliateshostingpackage'] = "חבילת אירוח";
$_LANG['affiliatesintrotext'] = "הפעל את חשבון השותפים שלך היום כדי:";
$_LANG['affiliateslinktous'] = "קשר אלינו";
$_LANG['affiliatesnosignups'] = "כרגע לא קיבלת שום הרשמות";
$_LANG['affiliatesrealtime'] = "נתונים סטטיסטיים אלה נמצאים בזמן אמת ומתעדכנים באופן מיידי";
$_LANG['affiliatesreferallink'] = "קישור ההפניה הייחודי שלך";
$_LANG['affiliatesreferals'] = "הפניות שלך";
$_LANG['affiliatesregdate'] = "תאריך רישום";
$_LANG['affiliatesrequestwithdrawal'] = "בקש משיכה";
$_LANG['affiliatessignupdate'] = "תאריך הרשמה";
$_LANG['affiliatesstatus'] = "סטטוס";
$_LANG['affiliatestitle'] = "שותפים";
$_LANG['affiliatesvisitorsreferred'] = "מספר מבקרים שהופנו";
$_LANG['affiliateswithdrawalrequestsuccessful'] = "בקשתך למשיכה הוגשה. ניצור איתך קשר בקרוב.";
$_LANG['affiliatesWithdrawalRequestUnsuccessful'] = "בקשתך למשיכה לא הצליחה. בבקשה נסה שוב מאוחר יותר.";
$_LANG['affiliateswithdrawn'] = "סכום כולל שנמשך";
$_LANG['all'] = "הכל";
$_LANG['alreadyregistered'] = "כבר רשום?";
$_LANG['announcementsdescription'] = "הצג את החדשות וההכרזות האחרונות שלנו";
$_LANG['announcementsnone'] = "אין הודעות לתצוגה";
$_LANG['announcementsrss'] = "צפה בעדכון RSS";
$_LANG['announcementstitle'] = "הכרזות";
$_LANG['announcementscontinue'] = "המשך לקרוא";
$_LANG['bannedbanexpires'] = "תוקף החסימה יפוג";
$_LANG['bannedbanreason'] = "סיבת החסימה";
$_LANG['bannedhasbeenbanned'] = "נאסר";
$_LANG['bannedtitle'] = "IP נאסר";
$_LANG['bannedyourip'] = "ה-IP שלך";
$_LANG['cartaddons'] = "תוספות";
$_LANG['cartbrowse'] = "עיין במוצרים &amp; שירותים";
$_LANG['cartconfigdomainextras'] = "הגדר תוספות דומיין";
$_LANG['cartconfigoptionsdesc'] = "למוצר/שירות זה יש כמה אפשרויות שתוכל לבחור מלמטה כדי להתאים אישית את ההזמנה שלך.";
$_LANG['cartconfigserver'] = "הגדר את השרת";
$_LANG['cartcustomfieldsdesc'] = "מוצר/שירות זה דורש ממך מידע נוסף כדי לאפשר לנו לעבד את ההזמנה שלך.";
$_LANG['cartdomainsconfig'] = "תצורת דומיינים";
$_LANG['cartdomainsconfigdesc'] = "להלן תוכל להגדיר את שמות הדומיינים בעגלת הקניות שלך, בחירה בשירותי התוסף שתרצה, מתן מידע נדרש עבורם והגדרת שרתי השמות שבהם הם ישתמשו.";
$_LANG['cartdomainshashosting'] = "יש אירוח";
$_LANG['cartdomainsnohosting'] = "אין שרת! לחץ כדי להוסיף";
$_LANG['carteditproductconfig'] = "ערוך תצורה";
$_LANG['cartempty'] = "עגלת הקניות שלך ריקה";
$_LANG['cartemptyconfirm'] = "האם אתם בטוחים שברצונכם לרוקן את עגלת הקניות שלכם?";
$_LANG['cartexistingclientlogin'] = "כניסה ללקוח קיים";
$_LANG['cartexistingclientlogindesc'] = "כדי להוסיף הזמנה זו לחשבון הקיים שלך, תצטרך להתחבר למטה.";
$_LANG['cartnameserversdesc'] = "אם אתה רוצה להשתמש בשרתי שמות מותאמים אישית, הזן אותם למטה. כברירת מחדל, דומיינים חדשים ישתמשו בשרתי השמות שלנו לאירוח ברשת שלנו.";
$_LANG['cartproductaddons'] = "תוספות למוצר";
$_LANG['cartproductaddonschoosepackage'] = "בחר חבילה";
$_LANG['cartproductaddonsnone'] = "אין תוספות זמינות עבור המוצרים שלך &amp; שירותים";
$_LANG['cartproductconfig'] = "תצורת המוצר";
$_LANG['cartproductdesc'] = "למוצר/שירות שבחרת יש את אפשרויות התצורה הבאות לבחירתך.";
$_LANG['cartproductdomain'] = "דומיינים";
$_LANG['cartproductdomainchoose'] = "בחר דומיין";
$_LANG['cartproductdomaindesc'] = "המוצר/שירות שבחרתם דורש שם דומיין. אנא הזן את שם הדומיין שלך למטה.";
$_LANG['cartproductdomainuseincart'] = "השתמש בדומיין שכבר נמצא בסל הקניות שלי";
$_LANG['cartremove'] = "הסר";
$_LANG['cartremoveitemconfirm'] = "האם אתה בטוח שברצונך להסיר פריט זה מהסל שלך?";
$_LANG['carttaxupdateselections'] = "ייתכן שייגבו מס בהתאם לבחירות המדינה והמדינה שתבחר. לחץ כדי לחשב מחדש לאחר ביצוע הבחירות שלך.";
...
$_LANG['checkout'] = "קנייה";
$_LANG['choosecurrency'] = "בחר מטבע";
$_LANG['choosedomains'] = "בחר דומיינים";
$_LANG['clickheretologin'] = "לחץ כאן כדי להיכנס";
$_LANG['clientareaaccountaddons'] = "תוספות חשבון";
$_LANG['clientareaactive'] = "פָּעִיל";
$_LANG['clientareaaddfundsdisabled'] = "אנו לא מאפשרים הפקדת כספים מראש אצלנו בשלב הנוכחי.";
$_LANG['clientareaaddfundsnotallowed'] = "חייבת להיות לך לפחות הזמנה פעילה אחת לפני שתוכל להוסיף כספים כדי שלא תוכל להמשיך בזמן הנוכחי!";
$_LANG['clientareaaddon'] = "תוספתן";
$_LANG['clientareaaddonorderconfirmation'] = "תודה. ההזמנה שלך עבור התוסף המוצג למטה בוצעה. אנא בחר את שיטת התשלום שלך מלמטה.";
$_LANG['clientareaaddonpricing'] = "תמחור";
$_LANG['clientareaaddonsfor'] = "תוספות עבור";
$_LANG['clientareaaddress1'] = "כתובת 1";
$_LANG['clientareaaddress2'] = "כתובת 2";
$_LANG['clientareabwlimit'] = "הגבלת רוחב פס";
$_LANG['clientareabwusage'] = "שימוש ברוחב פס";
$_LANG['clientareacancel'] = "בטל שינויים";
$_LANG['clientareacancelconfirmation'] = "תודה. בקשת הביטול שלך הוגשה. אם עשית זאת בטעות, פתח כרטיס תמיכה כדי להודיע לנו מיד או שחשבונך עלול להיסגר.";
