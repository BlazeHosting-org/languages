...
$_LANG['mysqlDatabases'] = "MySQLÂ® Databases";
...
$_LANG['store']['websiteBuilder']['introduction'] = "Weeblyâ€™s drag and drop website builder makes it easy to create a powerful, professional website without any technical skills. Over 40 million entrepreneurs and small businesses have already used Weebly to build their online presence with a website, blog or store.";
...
$_LANG['store']['sitelock']['cartShortDescription'] = "SiteLock provides a range of features designed to protect both your website and your businessâ€™ reputation.";
...
$_LANG['store']['sitelock']['featuresHeadline'] = "Provides a range of features designed to protect both your website and your businessâ€™ reputation:";
...
$_LANG['store']['ssl']['landingPage']['browser']['insecureNotice'] = "Web pages not served via HTTPS are now being displayed as â€˜not secureâ€™ in <strong>Google Chrome</strong> and <strong>Mozilla Firefox</strong>. Don't let your website be one of them. Add SSL today.";
...
$_LANG['store']['ssl']['landingPage']['help']['dv']['type'] = "Think of DV like getting a library cardâ€”no confirmation of who you really are, very minimal requirements to obtain and issued very quickly.";
...
$_LANG['store']['ssl']['landingPage']['help']['ov']['type'] = "Think of OV like getting a driverâ€™s licenseâ€”more hoops to jump through than a library card but more trusted as a form of identification.";
...
$_LANG['store']['ssl']['landingPage']['help']['ev']['type'] = "Think of EV like getting a passportâ€”much more stringent processes, longer lead times and more verification of who you are than with a library card or driverâ€™s license. Recognized internationally as the most trusted way to verify your identity.";
...
$_LANG['store']['ox']['faq8']['answer'] = "OX App Suite supports the following languages: English, German, Spanish, French, Italian, Dutch, Polish, ä¸­æ–‡ ç®€ä½“, ä¸­æ–‡ ç¹é«”, æ—¥æœ¬èªž æ—¥æœ¬";
...
$_LANG['store']['addon']['wptk']['introBody'] = "Take the guesswork, and the legwork, out of managing WordPress. In addition to everything youâ€™d expect, from easy backup and restores to search engine index management and one-click WordPress login, you also get automatic Smart Updates, staging and cloning to easily duplicate or test existing websites, one-click security hardening, and so much more!";
...
$_LANG['store']['addon']['wptk']['featureBody4'] = "Smart Updates automatically identifies and analyzes updates for compatibility and safety, then either installs or notifies you of any issue, ensuring your siteâ€™s safety.";
...
$_LANG['store']['addon']['wptk']['plesk']['featureBody2'] = "Test new features and ideas in a sandbox before pushing them to production â€“ No plugins required, no separate server needed.";
$_LANG['store']['addon']['wptk']['plesk']['featureTitle3'] = "Secure Against Attacks";
$_LANG['store']['addon']['wptk']['plesk']['featureBody3'] = "Hardens your site by default, further enhanced with the Toolkitâ€™s security scanner. No security expertise necessary.";
...
$_LANG['store']['siteBuilder']['featuresdescriptions']['essentials']['3'] = "You donâ€™t have to waste time manipulating content layouts. A collection of 350+ content blocks helps them build professional websites without any technical skills.";
...
$_LANG['store']['siteBuilder']['featuresdescriptions']['store']['1'] = "Whether youâ€™re a boutique, shop, or full store, plans available for 10, 50, and 500 products.";
...
$_LANG['store']['siteBuilder']['featuresdescriptions']['store']['7'] = "Inventory tracking helps to know if itâ€™s time to replenish a product stock and what product variations are the most popular.";
...
$_LANG['wptk']['installationSuccess'] = "<strong>Success!</strong> <a href=\"\" target=\"_blank\" id=\"newWordPressLink\">Visit</a> your new WordPressÂ® installation, or go to the <a href=\"\" target=\"_blank\" id=\"newWordPressAdminLink\">Admin Area</a>.";
...
$_LANG['ssl']['certError2'] = "If you submitted the configuration information recently, allow time for the certificate authority to complete security checks and issue the certificate. For DV orders, this is typically under 24 hours. OV and EV certificates may require up to 3â€“5 days.";
